  ...
  return (
    <div className="relative">
      ...
      <CustomDropdown
        ...
        className="absolute right-0 mt-[17px] flex w-[280px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark z-[9999]"
        style={{ 
          position: 'absolute',
          zIndex: 9999,
          pointerEvents: 'auto'
      ...
      >
        <div className="flex items-center gap-3 p-2">
          <span className="overflow-hidden rounded-full h-10 w-10 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
            {role.toLowerCase() === "resident" ? (
          ...
          <div className="flex-1 min-w-0">
            <span className="block font-medium text-gray-800 text-sm dark:text-gray-200 truncate">
              {user?.username || "User"}
            </span>
          ...
          <span>{renderRoleBadge(role.toLowerCase())}</span>
        </div>

        <div className="px-3 pt-2 text-[11px] uppercase tracking-wide text-gray-500 dark:text-gray-400">Account</div>
        ...
        <div className="px-3 pt-2 text-[11px] uppercase tracking-wide text-gray-500 dark:text-gray-400">Support</div>
        <ul className="flex flex-col gap-1 pt-2 pb-3 border-b border-gray-200 dark:border-gray-800">
          {(role === "admin" || role === "brgy") && (
            <li>
              <CustomDropdownItem
        ...
        <button
          className="flex items-center justify-center gap-2 px-3 py-2 mt-2 font-semibold rounded-lg text-sm bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500/30"
          onClick={logout}
          type="button"
        >
          <svg
