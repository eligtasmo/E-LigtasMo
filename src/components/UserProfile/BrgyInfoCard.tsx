        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{user?.full_name || user?.username || "-"}</p>
            </div>
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Barangay</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{user?.brgy_name || "-"}</p>
            </div>
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Province</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{user?.province || "-"}</p>
            </div>
            <div>
            ...
            <div>
              <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">Contact Number</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">{user?.contact_number || "-"}</p>
            </div>
          </div>
        </div>
        <button
